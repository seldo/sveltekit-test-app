...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-9d5bc250.js",
      css: [assets + "/_app/assets/start-61d1577b.css", assets + "/_app/assets/vendor-9612fc3e.css"],
      js: [assets + "/_app/start-9d5bc250.js", assets + "/_app/chunks/vendor-61da0e2a.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "baby_panda.jpg", "size": 33752, "type": "image/jpeg" }, { "file": "favicon.png", "size": 1571, "type": "image/png" }],
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-fe26f8e2.js", "css": ["assets/pages/__layout.svelte-ba4a406a.css", "assets/vendor-9612fc3e.css"], "js": ["pages/__layout.svelte-fe26f8e2.js", "chunks/vendor-61da0e2a.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-2288e555.js", "css": ["assets/vendor-9612fc3e.css"], "js": ["error.svelte-2288e555.js", "chunks/vendor-61da0e2a.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-02dcfd00.js", "css": ["assets/vendor-9612fc3e.css"], "js": ["pages/index.svelte-02dcfd00.js", "chunks/vendor-61da0e2a.js", "chunks/client-43887a07.js"], "styles": [] }, "src/routes/[uid].svelte": { "entry": "pages/[uid].svelte-c2eabb3c.js", "css": ["assets/vendor-9612fc3e.css"], "js": ["pages/[uid].svelte-c2eabb3c.js", "chunks/vendor-61da0e2a.js", "chunks/client-43887a07.js"], "styles": [] } };
...
var css$1 = {
  code: "nav.svelte-7dlfbq.svelte-7dlfbq{width:100%;padding-top:25px;padding-bottom:25px;text-shadow:0px 1px 3px rgba(0,0,0,.8), 0px 0px 6px rgba(0,0,0,.8)}nav.svelte-7dlfbq a.svelte-7dlfbq{color:white;text-decoration:none;padding-right:1rem}",
  map: '{"version":3,"file":"nav.svelte","sources":["nav.svelte"],"sourcesContent":["<nav class=\\"container\\">\\r\\n  <div class=\\"menu\\">\\r\\n    <a href=\\"/\\">Home</a>\\r\\n    <a href=\\"/about\\">About</a>\\r\\n  </div>\\r\\n</nav>\\r\\n\\r\\n<style>  \\r\\n  nav {\\r\\n    width: 100%;\\r\\n    padding-top: 25px;\\r\\n    padding-bottom: 25px;\\r\\n    text-shadow: 0px 1px 3px rgba(0,0,0,.8), 0px 0px 6px rgba(0,0,0,.8);\\r\\n  }\\r\\n  \\r\\n  nav a {\\r\\n    color: white;\\r\\n    text-decoration: none;\\r\\n    padding-right: 1rem;\\r\\n  }\\r\\n</style>\\r\\n"],"names":[],"mappings":"AAQE,GAAG,4BAAC,CAAC,AACH,KAAK,CAAE,IAAI,CACX,WAAW,CAAE,IAAI,CACjB,cAAc,CAAE,IAAI,CACpB,WAAW,CAAE,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,EAAE,CAAC,CAAC,CAAC,GAAG,CAAC,GAAG,CAAC,GAAG,CAAC,KAAK,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,EAAE,CAAC,AACrE,CAAC,AAED,iBAAG,CAAC,CAAC,cAAC,CAAC,AACL,KAAK,CAAE,KAAK,CACZ,eAAe,CAAE,IAAI,CACrB,aAAa,CAAE,IAAI,AACrB,CAAC"}'
};
var Nav = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css$1);
  return `<nav class="${"container svelte-7dlfbq"}"><div class="${"menu"}"><a href="${"/"}" class="${"svelte-7dlfbq"}">Home</a>
    <a href="${"/about"}" class="${"svelte-7dlfbq"}">About</a></div>
</nav>`;
});
var css = {
  code: ".absolute.svelte-1l4mczu{position:absolute;width:100%}",
  map: '{"version":3,"file":"__layout.svelte","sources":["__layout.svelte"],"sourcesContent":["<script>\\r\\n    import Nav from \\"./../lib/nav.svelte\\"\\r\\n    import \\"./../styles/reset.css\\";\\r\\n    import \\"./../styles/globals.css\\";\\r\\n<\/script>\\r\\n\\r\\n<div class=\\"flex-layout\\">\\r\\n    <header class=\\"absolute\\">\\r\\n        <Nav />\\r\\n    </header>\\r\\n    <slot></slot>\\r\\n    <p class=\\"footer\\">&copy; Seldo 2021</p>\\r\\n</div>\\r\\n\\r\\n<style>\\r\\n.absolute {\\r\\n    position: absolute;\\r\\n    width: 100%;\\r\\n  }\\r\\n</style>\\r\\n"],"names":[],"mappings":"AAeA,SAAS,eAAC,CAAC,AACP,QAAQ,CAAE,QAAQ,CAClB,KAAK,CAAE,IAAI,AACb,CAAC"}'
};
var _layout = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `<div class="${"flex-layout"}"><header class="${"absolute svelte-1l4mczu"}">${validate_component(Nav, "Nav").$$render($$result, {}, {}, {})}</header>
    ${slots.default ? slots.default({}) : ``}
    <p class="${"footer"}">\xA9 Seldo 2021</p>
</div>`;
});
...
var apiEndpoint = "https://seldo-svelte-kit-app.cdn.prismic.io/api/v2";
...
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${$$result.head += `${$$result.title = `<title>${escape(document.data.title)}</title>`, ""}`, ""}

<div class="${"header container"}" style="${"background-image: url('" + escape(document.data.image.url) + "')"}"><h1>${escape(document.data.title)}.</h1></div>

<div class="${"container"}"><!-- HTML_TAG_START -->${import_prismic_dom.default.RichText.asHtml(document.data.content)}<!-- HTML_TAG_END --></div>

<div class="${"container"}"><details><summary>This will show you baby animals!</summary>
        (Only two kinds)
    </details>

    <menu><li><a href="${"/dog"}">Baby dog</a></li>
        <li><a href="${"/panda"}">Baby panda</a></li></menu></div>`;
});
